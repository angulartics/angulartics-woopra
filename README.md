...
Woopra plugin for [Angulartics](http://github.com/angulartics/angulartics).
...
```shell
npm install angulartics-woopra
```
...
```shell
bower install angulartics-woopra
```

Add the `<script>` to your `index.html`:

```html
<script src="/bower_components/angulartics-woopra/dist/angulartics-woopra.min.js"></script>
```
